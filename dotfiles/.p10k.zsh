...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=231   # weiss
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=205   # hot pink
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=213  # pink
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=175
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=213   # pink
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=235   # dunkel auf pink
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=183      # lavendel
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=220   # gold
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=183  # lavendel
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=210 # lachsrosa
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=254    # hellgrau
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=175
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=218

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='✔'
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=175
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=218

  # Status when it's just an error code (e.g., '1'). No need to show it if prompt_char is enabled as
  # it will signify error by turning red.
  typeset -g POWERLEVEL9K_STATUS_ERROR=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=225
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=175
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=225
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=175

  # Status when some part of a pipe command fails and the overall exit status is also non-zero.
  # It may look like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=225
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=175

  ###################[ command_execution_time: duration of the last command ]###################
  # Execution time color.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=235
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=220  # gold
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=218   # soft pink
